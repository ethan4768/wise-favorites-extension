  ...
  (
    ...
    const CreatableItem = () => {
      ...
      const Item = (
        <CommandItem
          value={inputValue}
          className="cursor-pointer text-slate-700 text-xs"
          onMouseDown={(e) => {
            e.preventDefault()
            e.stopPropagation()
          }}
    ...
    return (
      <Command
        ...
        <div
          className={cn(
            "rounded-md border-none text-sm flex items-center hover:bg-gray-100",
            {
          ...
          <div className="relative flex flex-wrap gap-1 focus:bg-gray-100 items-center">
            {selected.map((option) => {
              return (
                <Badge
                  variant="outline"
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "h-6 flex-1 bg-transparent outline-none placeholder:text-muted-foreground px-1",
                {
